        ...
        <div className=''>
            ...
            <div className='px-12'>
                ...
                <div className='mt-4 mb-20'>
                    <h3 className='text-2xl mt-4 mb-1 text-blue-dark font-bold'>Creating new credentials</h3>
                    ...
                    <h3 className='text-2xl mt-4 mb-1 text-blue-dark font-bold'>Creating a Client ID in Moodle</h3>
                    <ol className='list-decimal pl-20 py-1 leading-7'>
                    ...
                    <h3 className='text-2xl mt-4 mb-1 text-blue-dark font-bold'>Configuring the external tool</h3>
                    <ol className='list-decimal pl-20 py-1 leading-7'>
                    ...
                    <h3 className='text-2xl mt-4 mb-1 text-blue-dark font-bold'>Adding the Client ID to LTI Pro Credentials</h3>
                    <ol className='list-decimal pl-20 py-1 leading-7'>
                    ...
                    <h3 className='text-2xl mt-4 mb-1 text-blue-dark font-bold'>Adding the Tool to Moodle Course</h3>
                    <ol className='list-decimal pl-20 py-1 leading-7'>
                    ...
                    <h3 className='text-2xl mt-4 mb-1 text-blue-dark font-bold'>Launching the LTI 1.3 tool</h3>
                    <ol className='list-decimal pl-20 py-1 leading-7'>
