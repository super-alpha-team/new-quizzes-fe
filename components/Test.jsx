...
import Essay from './questionares/Essay';
...
import ShortAnswer from './questionares/ShortAnswer';

function Test() {
    const data = Array(6).fill('matching answer sample');
    // return (
    //     <div>
    ...
    //                                 </div>
    //                             </div>
    //                             <Clock duration={10} handleTimeUp={() => null} />
    //                         </div>
    //                     </div>
