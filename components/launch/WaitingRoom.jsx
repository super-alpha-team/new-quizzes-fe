    ...
    return (
        <div>
            ...
            <div className='flex justify-between mt-4'>
                <div className="w-20 h-20 mx-24 rounded-full border-2 border-qpurple-light flex justify-center items-center">
                    <p className='text-qpurple text-3xl'>{listStudentName.length}</p>
                </div>
